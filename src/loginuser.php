...
<div  id="logins" align:'center' class='outerform' style='margin-top: 50px;'>
        <div align:'left' class='formcontainer'>
          <div class='innerformcontainer' style="padding:10px;text-align: center;">
            ...
            <div class='forminputs' style="padding:5px;margin: 30px;text-align: center;">
              <span title="cancel" class="close" onclick="displayWindow2()">&times;</span> 
            <form>
              ...
              <div style="font-size: 11px; color:yellow ;margin-top:10px;"><?php echo"Error message here.......";?></div>
            </div>
          </div>
        </div>
    </div>